        ...
        render() {
                ...
                return this.state.loaded ?
                    ( <
                        ...
                        source = {
                            require('../../assets/images/chef-hat.png')
                        }
                        /> {
                            !this.state.isSelf && < Text style = {
                                    [styles.defaultTxt, styles.usernameTxt]
                                } > {
                                ...
                                /Text>} {
                                    this.state.isSelf && < Text style = {
                                        ...
                                        <
                                        Text style = {
                                            [styles.progressMetaTxt]
                                        } > {
                                            this.state.isSelf ? `${this.state.progressPercent}%` : ''
                                        } <
                                        /Text> <
                                        Text style = {
                                            [styles.progressMetaTxt, styles.progressMetaTxtLarge]
                                        } >
                                        Level {
                                            this.state.user.level.number
                                        } <
                                        /Text> <
                                        Text style = {
                                            [styles.progressMetaTxt, styles.progressMetaTxtSmall]
                                        } > {
                                        ...
                                        /View> {
                                            this.state.isSelf && < View style = {
                                                ...
                                                /View> { < View style = {
                                                        ...
                                                        <
                                                        Text style = {
                                                            [styles.defaultTxt, styles.centerTxt, styles.levelName]
                                                        } > {
                                                            this.state.user.level.name
                                                        } < /Text> {
                                                            this.state.isSelf && < Text style = {
                                                                    [styles.defaultTxt, styles.centerTxt]
                                                                } > {
                                                                    this.state.user.level.description
                                                                } < /Text>} <
                                                                /View>} <
                                                                View style = {
                                                                    [styles.flexColumn, styles.history]
                                                                } >
                                                                <
                                                                Text style = {
                                                                    [styles.defaultTxt, styles.centerTxt]
                                                                } > {
                                                                    this.state.isSelf ? 'Player since' : 'Last signed on'
                                                                } < /Text> <
                                                                Text style = {
                                                                    [styles.defaultTxt, styles.centerTxt]
                                                                } > {
                                                                    this.state.isSelf ? createdOn : lastSignOn
                                                                } < /Text> <
                                                                /View> <
                                                                View style = {
                                                                    [styles.statWrapper]
                                                                ...
                                                                TouchableOpacity
                                                            style = {
                                                                [styles.flexColumn, styles.statBox]
                                                            }
                                                            onPress = {
                                                                ...
                                                                <
                                                                Text style = {
                                                                    [styles.defaultTxt, styles.centerTxt, styles.playStatNum]
                                                                } > {
                                                                    this.state.user.completed.length
                                                                } < /Text> <
                                                                Text style = {
                                                                    [styles.defaultTxt, styles.centerTxt, styles.playStatTxt]
                                                                } > Completion {
                                                                    this.state.user.completed.length === 1 ?
                                                                        '' :
                                                                        's'
                                                                } < /Text> <
                                                                /TouchableOpacity> <
                                                            ...
                                                            onPress = {
                                                                ...
                                                                Text style = {
                                                                    ...
                                                                    this.state.user.friends.length === 1 ?
                                                                        '' :
                                                                        's'
                                                                } <
                                                                /Text> <
                                                                ...
                                                                View style = {
                                                                    ...
                                                                    this.state.isSelf && < TouchableOpacity style = {
                                                                        [styles.button, styles.logoutButton]
                                                                    }
                                                                    onPress = {
                                                                    ...
                                                                    Text
                                                                    style = {
                                                                        [styles.defaultTxt, styles.buttonTxt]
                                                                    }
                                                                    userID >
                                                                    Logout < /Text> <
                                                                    /TouchableOpacity>} <
                                                                    ...
                                                                    onPress = {
                                                                        () => this.state.isSelf ? this.props.navigation.navigate('Home') : this.props.navigation.goBack()
                                                                    } >
                                                                    <
                                                                    Text
                                                                    style = {
